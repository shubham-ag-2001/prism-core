...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiResponse<Void>> handlePrismException(PrismException ex) {
        log.warn("PrismException: [{}] {}", ex.getErrorCode(), ex.getMessage());
    ...
    public ResponseEntity<ApiResponse<Void>> handleBadCredentials(BadCredentialsException ex) {
        return ResponseEntity.status(HttpStatus.UNAUTHORIZED)
                .body(ApiResponse.error("Invalid credentials", ErrorCode.UNAUTHORIZED));
    }
